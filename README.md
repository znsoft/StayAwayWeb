...
Нечто (Stay Away)
    ...
    Создатели: Antonio Ferrara, Sebastiano Fiorillo. Расcчитана на количество от 4 до 12 игроков, но оптимальное количество игроков -  6 или 8. 
    
    Рекомендуемый возраст 12+ . Среднее время игры: 15-60 минут.
